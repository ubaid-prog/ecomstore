        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <?php 
                    ...
                    while($run_terms=mysqli_fetch_array($run_term)){
                        
                        $term_id = $run_terms['term_id'];
                        
                        $term_title = $run_terms['term_title'];

                        $term_link = $run_terms['term_link'];
                        
                        $term_desc = substr($run_terms['term_desc'],0,400);
