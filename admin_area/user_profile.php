                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input  name="admin_image" type="file" class="form-control" required>
                             ...
                             <img src="admin_images/<?php echo $admin_image; ?>" alt="<?php echo $admin_name; ?>" width="100" height="100">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                         ...
                         <textarea  name="admin_about" class="form-control" cols="30" rows="7"> <?php echo $user_about;?> </textarea>
...
<?php
    ...
    if(isset($_POST['update'])){
        ...
        admin_country='$user_country',admin_contact='$user_contact',admin_job='$user_job',
        admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
