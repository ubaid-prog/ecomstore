 ...
 <div class="form-group"><!-- form-group start-->
  ...
  <div class="form-group"><!-- form-group start-->
   ...
   <div class="text-center"><!-- text-center start-->
    ...
    <button class="btn btn-primary" name="update"><!-- btn btn-primary start-->
...
if(isset($_POST['update'])){
  ...
  $update_customer = "update customers set customer_name = '$c_name',customer_email='$c_email',customer_country='$c_counrty',customer_city='$c_city',
  customer_address='$c_address',customer_contact='$c_contact',customer_image='$c_image' where customer_id='$update_id'";
  $run_customer = mysqli_query($con,$update_customer);
  if($run_customer){
    echo "<script>alert('Your account has been updated, please login again to make these changes effective')</script>";
